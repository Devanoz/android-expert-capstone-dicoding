...
package com.example.favourite.databinding;
...
public final class ActivityFavouriteBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvFavouriteGames;

  private ActivityFavouriteBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView rvFavouriteGames) {
    this.rootView = rootView;
    this.rvFavouriteGames = rvFavouriteGames;
  }
  ...
  public static ActivityFavouriteBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.rv_favourite_games;
      RecyclerView rvFavouriteGames = ViewBindings.findChildViewById(rootView, id);
      if (rvFavouriteGames == null) {
        break missingId;
      }

      return new ActivityFavouriteBinding((ConstraintLayout) rootView, rvFavouriteGames);
    }
